...
static esp_err_t cmd_handler(httpd_req_t *req)
{
    ...
    else if (!strcmp(variable, "flash") || !strcmp(variable, "led") || !strcmp(variable, "led_intensity")) {
        int flashPin = 4; // AI-Thinker ESP32-CAM Onboard Flash LED (GPIO 4)
        pinMode(flashPin, OUTPUT);
        digitalWrite(flashPin, val > 0 ? HIGH : LOW);
        res = 0;
    }
